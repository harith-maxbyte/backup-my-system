...
import Newsidebar from "../MainLayout/components/Newsidebar/Newsidebar";
...
class NewMainLayout extends Component {
    ...
    render() {
        ...
        const { children, classes, isDesktop } = this.props;
...
export default React.memo(withStyles(styles)((withMediaQuery([
